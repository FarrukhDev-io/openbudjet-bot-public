...
export const StatsGrid: React.FC<StatsGridProps> = React.memo(({ stats }) => {
  return (
    <div className="grid grid-cols-2 gap-3 mb-4">
      <div className="bg-slate-900 border border-slate-800/60 rounded-2xl p-3 flex flex-col justify-center">
      ...
      <div className="bg-slate-900 border border-slate-800/60 rounded-2xl p-3 flex flex-col justify-center col-span-2">
        <div className="flex justify-between items-center mb-1">
